	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="index.jsp">Home</a> Â» <span class="breadcrumb_last" aria-current="page">About</span>
			</div>
		</nav>
	</div>
	<!-- /about-->
		...
		<div class="container py-lg-4">
			<div class="row ab-grids-sec align-items-center">
				<div class="col-lg-6 ab-right">
					<img class="img-fluid" src="assets/images/amaran.jpg">
				</div>
				<div class="col-lg-6 ab-left pl-lg-4 mt-lg-0 mt-5">
					<h3 class="hny-title">Ceylon Cinema Entertainment</h3>
...
<div class="swiper-container" style="background-color: var(--theme-bg);">
	...
	<div class="swiper-wrapper">
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/img1.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-1">Dineth<br></h3>
				<div class="p-sm">
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/img2.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-2">Meraj<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/img3.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-2">Amandi<br></h3>
				<div class="p-sm">
						<a href="#"><i class="fa fa-linkedin"></i></a>
						<a href="#"><i class="fa fa-instagram"></i></a>
						<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
					<img src="assets/images/img4.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
					<h3 id="details-h3-2">Sandali<br></h3>
					<div class="p-sm">
							<a href="#"><i class="fa fa-linkedin"></i></a>
							<a href="#"><i class="fa fa-instagram"></i></a>
							<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
				<div class="imgBx">
						<img src="assets/images/img5.jpeg" style="width :100%; height: 100%">
				</div>
				<div class="details">
						<h3 id="details-h3-2">Sandilu<br></h3>
					<div class="p-sm">
							<a href="#"><i class="fa fa-linkedin"></i></a>
							<a href="#"><i class="fa fa-instagram"></i></a>
							<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
				<div class="imgBx">
						<img src="assets/images/img6.jpeg" style="width :100%; height: 100%">
				</div>
					<div class="details">
						<h3 id="details-h3-2">Tharaka<br></h3>
						<div class="p-sm">
								<a href="#"><i class="fa fa-linkedin"></i></a>
								<a href="#"><i class="fa fa-instagram"></i></a>
								<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/img7.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-3">Chamod<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/img8.jpeg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Rashini<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
